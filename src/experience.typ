...
#let experience = {
    ...
    sect(
        ...
        bullets: (
            ...
            "Researched and introduced Swift structured concurrency to the iOS app, reducing the 90-day crash rate by ~85% from ~2,200 crashes to ~320 crashes, improving user experience and app stability."
        )
    )
    sect(
        "Consultant",
